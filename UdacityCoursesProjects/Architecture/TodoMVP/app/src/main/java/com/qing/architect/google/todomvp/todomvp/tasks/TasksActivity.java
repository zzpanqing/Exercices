...
import com.qing.architect.google.todomvp.todomvp.Injection;
import com.qing.architect.google.todomvp.todomvp.R;
import com.qing.architect.google.todomvp.todomvp.StatisticsActivity;
import com.qing.architect.google.todomvp.todomvp.utils.ActivityUtils;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case android.R.id.home:
                // Open the navigation drawer when the home icon is
