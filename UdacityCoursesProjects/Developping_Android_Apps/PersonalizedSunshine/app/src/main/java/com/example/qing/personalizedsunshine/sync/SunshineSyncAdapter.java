package com.example.qing.personalizedsunshine.sync;
...
import com.example.qing.personalizedsunshine.MainActivity;
import com.example.qing.personalizedsunshine.R;
...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    // id matched to the notification so that you can reuse it
    public static final int WEATHER_NOTIFICATION_ID = 3004;
    /**
     * your notification data will be pulled from the database, you need to
     * add projection and column indices values
     */
    ...
    long addLocation(String locationSetting, String cityName, double lat, double lon) {
        ...
        Cursor c = null;
            ...
            c = getContext().getContentResolver().query(WeatherContract.LocationEntry.CONTENT_URI,
        ...
        long location_ID = -1;
        if(c.moveToFirst()) {
            location_ID= c.getLong(c.getColumnIndex(WeatherContract.LocationEntry._ID));
        }
        else {
            ...
            Uri insertedUri = null;
                insertedUri = getContext().getContentResolver().insert(WeatherContract.LocationEntry.CONTENT_URI, values);
    ...
    private void getWeatherDataFromJson(String forecastJsonStr,
        ...
        try {
            ...
            if ( cVVector.size() > 0 ) {
                ...
                ContentValues[] a = new ContentValues[cVVector.size()];
                cVVector.toArray(a);
                inserted = getContext().getContentResolver().bulkInsert(WeatherContract.WeatherEntry.CONTENT_URI, a);
