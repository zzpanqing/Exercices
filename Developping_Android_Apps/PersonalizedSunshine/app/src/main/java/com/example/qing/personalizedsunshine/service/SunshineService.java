...
/**
 * Created by Qing on 16/01/17.
 */

public class SunshineService extends IntentService {
    public  static final String LOCATION_QUERY_EXTRA = "lqe";
    private static final String LOG_TAG = "test";//SunshineService.class.getName();
    ...
    long addLocation(String locationSetting, String cityName, double lat, double lon) {
        ...
        Cursor c = getContentResolver().query(WeatherContract.LocationEntry.CONTENT_URI,
    ...
    private void getWeatherDataFromJson(String forecastJsonStr,
        ...
        try {
            ...
            if ( cVVector.size() > 0 ) {
                ...
                cVVector.toArray(a);
                inserted = getContentResolver().bulkInsert(WeatherContract.WeatherEntry.CONTENT_URI, a);
            }
